            ...
            <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
              <div class="team-member">
                  <div class="member-img">
                      <img src="{{ asset('uploads/' . @$item->image) }}" class="img-fluid imge_hight"
                          alt="">
                  </div>
                  <div class="member-info">
                      ...
                      <span><button
                              class="btn btn-{{ get_status_class_teacher(@$item->status) }}">{{ get_status_teacher(@$item->status) }}</button></span>
