...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/css/forms/tags/tagging.css') }}">
...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click"
    ...
    <script src="{{ asset('backend/js/scripts/tables/datatables/datatable-advanced.js') }}" type="text/javascript">
        < script src = "{{ asset('backend/vendors/js/forms/tags/tagging.min.js') }}"
        type = "text/javascript" >
    </script>
    <script src="{{ asset('backend/js/scripts/forms/tags/tagging.js') }}" type="text/javascript"></script>
